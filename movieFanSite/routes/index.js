...
const request = require('request');//request library is used to make outside requests of your app for Node

const apiKey = '1fb720b97cc13e580c2c35e1138f90f8';
const apiBaseUrl = 'https://api.themoviedb.org/3';
// const apiBaseUrl = 'http://localhost:3030';
// const nowPlayingUrl = `${apiBaseUrl}/most_popular?api_key=${apiKey}`;
const nowPlayingUrl = `${apiBaseUrl}/movie/popular?api_key=${apiKey}&language=en-US`;
